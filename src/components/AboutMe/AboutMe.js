  ...
  return (
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__content">
        ...
        <p className="about-me__description">Я родилась в Астраханской области, но живу в Вологде, закончила электроэнергетический факультет ВоГУ. У меня есть парень и кошка. Я люблю путешествовать, веду блоги и изучаю английский язык. С 2013 по 2016 год работала программистом C++ в "R-Style Softlab", затем перешла в компанию "СберТех" и стала Java разработчиком. Последние пару лет работаю DevOps инженером.</p>
